...
const en: Dict = {
  ...
  "terminal.offline": "No scan service connected.",
  "terminal.offlineTitle": "Terminal is offline",
  "terminal.offlineDesc": "This is a static site on GitHub Pages — no backend is running. You have 3 options:",
  "terminal.offlineStep1": "Option A — Upload a JSON report",
  "terminal.offlineStep2": "Option B — Self-host the scan-service",
  "terminal.offlineStep3": "Option C — Copy & run locally",
  "terminal.connected": "Connected",
  "terminal.hint": "webscan commands only. Type a command and press Run, or Copy to run locally.",
  "terminal.autoLoad": "Scan complete — auto-loading report into analyzer…",
  "terminal.connectBackend": "Connect scan backend",
  "terminal.connectBackendDesc": "Point the terminal at a self-hosted scan-service to run live scans from the browser.",
  "terminal.connectBackendHint": "URL of your locally-running scan-service (from mini-services/scan-service). Leave empty to use the sandbox proxy.",
...
const ru: Dict = {
  ...
  "terminal.offline": "Scan-сервис не подключён.",
  "terminal.offlineTitle": "Терминал офлайн",
  "terminal.offlineDesc": "Это статичный сайт на GitHub Pages — backend не запущен. У тебя 3 варианта:",
  "terminal.offlineStep1": "Вариант A — Загрузить JSON-отчёт",
  "terminal.offlineStep2": "Вариант B — Запустить scan-service локально",
  "terminal.offlineStep3": "Вариант C — Скопировать и запустить локально",
  "terminal.connected": "Подключено",
  "terminal.hint": "Только команды webscan. Введи команду и нажми Запуск, или Скопировать для запуска локально.",
  "terminal.autoLoad": "Скан завершён — автоматически загружаю отчёт в анализатор…",
  "terminal.connectBackend": "Подключить backend",
  "terminal.connectBackendDesc": "Укажи URL своего scan-service, чтобы запускать сканы прямо из браузера.",
  "terminal.connectBackendHint": "URL твоего локального scan-service (из mini-services/scan-service). Оставь пустым для proxy по умолчанию.",
